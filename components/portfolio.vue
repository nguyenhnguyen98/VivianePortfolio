    ...
    data() {
      return {
        ...
        works: [
          ...
          {source: 'school/pocky_final-min.png', tag: '#design', desc: 'School project involving the re-branding of a food brand. In this case, Pocky. <a href="https://pdfhost.io/v/NlW9yFkwX_tranle_viviane_f21_rebranding_presentation_1" target="_blank" class="underline">See more</a>'},
          {source: 'school/pocky_final2-min.png', tag: '#design', desc: 'School project involving the re-branding of a food brand. In this case, Pocky. <a href="https://pdfhost.io/v/NlW9yFkwX_tranle_viviane_f21_rebranding_presentation_1" target="_blank" class="underline">See more</a>'},
          {source: 'school/pocky_final3-min.png', tag: '#design', desc: 'School project involving the re-branding of a food brand. In this case, Pocky. <a href="https://pdfhost.io/v/NlW9yFkwX_tranle_viviane_f21_rebranding_presentation_1" target="_blank" class="underline">See more</a>'},
          {source: 'personal/Work-1.jpg', tag: '#illustration'},
          {source: 'school/Osheaga.jpg', tag: '#design', desc: 'School project involving the re-branding of a festival. In this case, Osheaga. <a href="https://pdfhost.io/v/RXz0W0yPH_tranle_viviane_capsulecollection" target="_blank" class="underline">See more</a>'},
          ...
          {source: 'school/bookcover-min.png', tag: '#design'},
